...
namespace Bing
{
    ...
    {
        private static BingSearchContainer bingSearchContainer;

        static BingSearch()
        {
            bingSearchContainer = new BingSearchContainer(new Uri("https://api.datamarket.azure.com/Bing/SearchWeb/v1/"));
            bingSearchContainer.Credentials = new NetworkCredential("c9926862-977b-4c7d-84c0-3bb1b22c6839", "91O/KFDsveEly6nm8FJhVmiHpv7qEzQnEaJ0YnerfOE=");
        }
        ...
        public static List<String> Search(string query)
        {
            ...
            DataServiceQuery<WebResult> Results = bingSearchContainer.Web(query);
            int Count = 0;
    ...
    public partial class BingSearchContainer : System.Data.Services.Client.DataServiceContext
    {
        ...
        public DataServiceQuery<WebResult> Web(String Query, String Market = null, String Adult = null, Double? Latitude = null, Double? Longitude = null, String WebFileType = null, String Options = null, String WebSearchOptions = null)
        {
            if ((Query == null))
            {

...
namespace DataAccess.models
{
    ...
    public class Video : INotifyPropertyChanged, IPreviewInfoRetriever
    {
        ...
        private global::DataAccess.models.ImageInfo _poster;
        //private List<ImageInfo> _images;
        private String _plot;
        private bool _analyseCompleted;
        private VideoTypeEnum _videoType;
        private List<Tmc.SystemFrameworks.Model.VideoFile> _files;

        private global::DataAccess.models.MovieInfo _movieInfo;
        private global::DataAccess.models.EpisodeInfo _episodeInfo;
            ...
            : this()
        {
            ...
            {
                MovieInfo = new global::DataAccess.models.MovieInfo();
            }
            else if (VideoType == VideoTypeEnum.Episode)
            {
                EpisodeInfo = new global::DataAccess.models.EpisodeInfo();
            }
        }

        public Video()
        {
			_images = new List<global::DataAccess.models.ImageInfo>();
            _genres = new List<Genre>();
            _analyseCompleted = false;
            _files = new List<Tmc.SystemFrameworks.Model.VideoFile>();

			_release = new DateTime(1800, 1, 1); //earlier dates ar not supported by sql ce
        }

        public Video(string path, params global::DataAccess.models.Subtitle[] subs)
            : this()
        {
            Files.Add(new Tmc.SystemFrameworks.Model.VideoFile { Path = path, Subs = new ObservableList<global::DataAccess.models.Subtitle>(subs) });
        }
        ...
        public void CopyAnalyseVideoInfo(Video brother, Boolean overwrite = true)
        {
            ...
            {
                if (Images == null)
                    Images = new List<global::DataAccess.models.ImageInfo>();
				else
                {
					//Images.Clear(); --> might cause problems with EF
		...
		[ForeignKey("Id")]
        public global::DataAccess.models.MovieInfo MovieInfo
        {
		...
		[ForeignKey("Id")]
        public global::DataAccess.models.EpisodeInfo EpisodeInfo
        {
            get { return _episodeInfo; }
            set { _episodeInfo = value; }
        }

        public List<Tmc.SystemFrameworks.Model.VideoFile> Files
        {
            get { return _files; }
            set { _files = value; }
        }
	    ...
	    private List<global::DataAccess.models.ImageInfo> _images;// = new List<ImageInfo> { new ImageInfo { UriString = "http://upload.wikimedia.org/wikipedia/commons/e/e7/Mozilla_Firefox_3.5_logo_256.png" } };
		public virtual List<global::DataAccess.models.ImageInfo> Images
        {
            get { return _images; }
            set
            {
		...
		[NotMapped]
        public global::DataAccess.models.ImageInfo Thumbnail
        {
            get
            {
		...
		[NotMapped]
        public global::DataAccess.models.ImageInfo Poster
        {
            get
            {
